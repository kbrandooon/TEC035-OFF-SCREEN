      ...
      <ul className='divide-y divide-slate-100 dark:divide-slate-700/50'>
        {inventory.map((movement) => {
          ...
          return (
            ...
            >
              {/* Movement type icon */}
              <div className={`flex size-10 shrink-0 items-center justify-center rounded-lg border ${cfg.classes}`}>
                <span className='material-symbols-outlined text-[20px] font-normal'>{cfg.icon}</span>
              </div>
              ...
              <div className='flex min-w-0 flex-1 flex-col'>
                ...
                <div className='mt-0.5 flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400'>
                  ...
                  {movement.description && <span className='truncate'>{movement.description}</span>}
                </div>
              </div>
              ...
              {/* Quantity */}
              <span className={`flex items-center gap-1 rounded-full border px-3 py-1 text-sm font-bold ${cfg.classes}`}>
